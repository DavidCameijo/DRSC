...
sim_time = 1000
dist_type = "poisson" # Distribution type to analyze (e.g., "poisson", "uniform", "deterministic")
...
plt.title(f"Exercício 3: Convergência da Latência ({dist_type})")
plt.legend()
